# For SimpleFlightSearch

This is Java + Spring MVC project which was build using maven and deployed on Tomcat7 server

# for SimpleFlightSearchUI

The project was build in Angualr 6 which fetches results from Spring MVC Aplication/ REST Api
